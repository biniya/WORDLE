<template>
  <header class="font-Montserrat antialiased sticky rounded top-0 z-50">
    <div class="block sm:hidden bg-white">
      <button
        @click="toggle"
        class="inline items-center px-3 py-2 border rounded text-black border-grey-dark-light hover:text-black hover:border-white"
      >
        <svg
      ...
      <span class="ml-3 text-2xl text-black font-bold inline item-center"
        >Wordle</span
      >
    </div>
    <div
      :class="open ? 'block' : 'hidden'"
      class="overflow-hidden w-full flex-grow sm:flex sm:items-center sm:w-auto bg-white to-gray-200"
    >
      <div class="text-sm sm:hidden">
        <button type="button" @click="showHowToPlay">
          <!-- Question mark svg small -->
          <svg
            version="1.1"
            id="Capa_1"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <nav
      class="bg-white sm:block p-4 font-bold text-2xl rounded shadow-lg"
      :class="open ? 'hidden' : 'hidden'"
    >
      <div class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
        <div class="flex justify-center items-center text-sm sm:flex-grow">
          <!-- Wordle svg -->
          <svg
            id="Diagram"
            width="7mm"
          ...
          <a
            href="#wordle"
            class="pl-6 no-underline block mt-4 sm:inline-block sm:mt-0 text-black mr-8"
          >
            WORDLE
          </a>
        </div>
